...
- Phase 5 : Post-quantique (Dilithium3 + Kyber768) — **EN COURS** (étape 1 ✅ liboqs intégré le 30 mai 2026 ; étape 2 ✅ types de clés PQ + ops Dilithium3/Kyber768 + HFv16 placeholder le 31 mai 2026 ; étape 3 ✅ intégration Dilithium3 dans le flow de signature des TX le 3 juin 2026, commit `3c92a61d9`, gardé par HFv16 ; étape 4 ✅ dérivation stealth addresses BQ... via Kyber768 le 4 juin 2026, commit `0c489dbdc`, gardé par HFv16 + flag `is_pq` ; étape 5 ✅ format d'adresse BQ... + plumbing clés Kyber768 wallet le 4 juin 2026, commit `b77639979`, gardé par HFv16 + `is_pq`, format B... byte-identique ; items ouverts étape 5 : keygen BQ/subaddress (rien ne set `pq_keys`), tuning préfixe mnemonic (`0x3C11` rend "RLF..." pas "BQ"), `hf_version` dans unsigned-tx cold-signing ; voir section POST-QUANTIQUE ; cible hard fork mainnet T2 2027)
