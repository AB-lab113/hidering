...
> **⚠️ NB nomenclature M-x — DEUX séries homonymes.** Les findings `M-n` de CETTE section (et du header « Dernière MAJ ») sont le **backlog de remédiation de juin 2026** : M-3 `.keys` sans MAC, M-5 seeds Tor/i2p, M-6 DNSSEC seeds, M-7 padding 2500, M-9 rapidjson CVE, M-10/M-11 liboqs, M-13 RPC pool. Ils sont **distincts et SANS RAPPORT** avec les `M-1..M-6` de l'**audit PQC du 5 juin** (section POST-QUANTIQUE › Étape 8 : M-1/M-2 TLV tx_extra, M-3 memwipe secrets PQ, M-4 discipline at-rest, M-5 validation longueurs Dilithium, M-6 `HF_HEIGHT_PQ` 1M→2M). **M-3 / M-5 / M-6 sont des homonymes** entre les deux séries → toujours désambiguïser par la section. (Même convention dans les mémoires : `project_audit_findings_2026-06-06` + `MEMORY.md` = série backlog ; `project_phase5_security_audit_fixes` + `project_full_audit_2026-06-10` = série audit PQC.)
